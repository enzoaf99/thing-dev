...
export default function About() {
    return (
        <>
            <div className="flex flex-col py-20 px-16 items-start lg:flex-row lg:items-start">
                <div className='w-full lg:w-1/2 lg:mr-2'>
                    <Image src={about} alt={'About'}></Image>
                </div>
                <div className='w-full lg:w-1/2 lg:ml-2 mt-4 lg:mt-0'>
                    <h3 className={'text-thing-primary font-bold text-2xl pt-7 lg:text-4xl lg:pt-0 '}>Código de calidad, soluciones para tu empresa</h3>
                    <p className={'py-7'}>En ThingDev nos apasiona la programación y estamos comprometidos a brindar soluciones digitales de alta calidad a empresas de todos los tamaños. Con nuestra dedicación, experiencia y compromiso con la innovación, puede estar seguro de que obtendrá los mejores resultados.</p>
                    <Accordion defaultExpandedKeys={["1"]}>
                        <AccordionItem key="1" aria-label="Accordion 1" subtitle="Click para expandir" title="¿Que servicios ofrecemos?">
                        ...
                        <AccordionItem key="2" aria-label="Accordion 2" subtitle="Click para expandir" title="¿Cómo es el proceso con nosotros?">
                        ...
                        <AccordionItem key="3" aria-label="Accordion 3" subtitle="Click para expandir" title="Nuestros valores">
